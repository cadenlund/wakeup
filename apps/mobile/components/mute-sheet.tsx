// Mute-options drawer for a conversation. Five durations
...
// (Phase 5.7+). Layout responsibility lives in <DrawerSheet>:
// bottom drawer on native, centered modal card on web.
...
export function MuteSheet({ visible, isMuted, onPickUntil, onUnmute, onClose, testID }: Props) {
  ...
  return (
    <DrawerSheet
      visible={visible}
      onClose={onClose}
      dismissLabel="Dismiss mute options"
      testID={testID}>
